...
const ROUND2_SCENARIOS = {
  CRISIS: {
    ...
    responses: {
      ...
      'MONO-R': 'The plan has been scrapped. I have already started. Sleep is a problem for the version of me that exists on Thursday.',
      ...
      'GRUUL': 'Gut says the data is the obstacle. Remove the obstacle. Push until it moves. It always moves.',
      ...
      'IZZET': 'Finally, a deadline with ambition. Prototype three unreasonable solutions tonight. Ship whichever one explodes least.',
      'GOLGARI': 'Accept this iteration is dead. Recycle what works and grind out a sustainable version 2.0.',
      'BOROS': 'Everyone up. One objective, full attention, no side quests. We start now and we stop when it’s fixed.',
      ...
      'GRIXIS': 'The whining is optional; the deadline isn’t. Find the weak point, take every shortcut with a straight face, and ship.',
      'JUND': 'Survival of the fittest. The weak ideas die now. We hunt for the solution with aggression.',
      'NAYA': 'Get everyone in one room. People move mountains for a thing they believe in, and I intend to be extremely believable for the next 48 hours.',
      ...
      'MARDU': 'We hit it now, together, hard. Some things will break in the process. The deadline will not be one of them.',
  ...
  CONFLICT: {
    ...
    responses: {
      ...
      'MONO-R': 'Say the loud parts out loud, both of you, fully, today. Then we hug and move on. This works more often than HR would prefer.',
      ...
      'RAKDOS': 'Let them fight. It’s the most honest meeting this project will ever have. Winner takes it.',
      ...
      'IZZET': "You're both wrong, which is freeing. I have a third, weirder option, and it has the advantage of being mine.",
      'GOLGARI': 'This conflict is wasteful. One of you should step down so the other can thrive.',
      'BOROS': 'Both of you, stand down. The mission outranks your egos and, administratively speaking, so do I.',
      ...
      'NAYA': "We're a team, arguably a family. Families argue. Then someone senior decides, and everyone brings their heart back to work.",
  ...
  PIVOT: {
    ...
    responses: {
      ...
      'MONO-R': "Yes. Obviously yes. My current job has been suffocating me for two years, and the notice letter has, in a sense, already been drafted.",
      ...
      'IZZET': 'High risk, no structure, everything on fire from day one. I have never signed anything faster.',
  ...
  MISTAKE: {
    ...
    responses: {
      ...
      'MONO-R': "That one's mine. I broke it, I'm fixing it, and I've already started. Apologies will be issued retroactively.",
      ...
      'RAKDOS': "Laugh it off. If nothing's breaking, nobody's moving. This is what progress smells like.",
      ...
      'IZZET': "Unintended, yes, but look at the result. Genuinely interesting. Running the inverse now to see if it un-happens.",
      'GOLGARI': 'Bury the failure. Let it rot. Build something better on top of the compost.',
      'BOROS': "Full responsibility, formally, on the record. Whatever the consequence is, I'll take it standing up, and it won't happen twice.",
      ...
      'MARDU': "Dwelling is for later. Fix first, feelings after, and if we move fast enough there won't be time for either.",
  ...
  BURNOUT: {
    ...
    responses: {
      ...
      'MONO-R': "I'm taking tomorrow off, for everyone's safety. Mine mostly, but not exclusively.",
      ...
      'GRUUL': "The calendar is the problem. I've declined everything. I'll re-emerge when I can think in full sentences.",
      ...
      'IZZET': "More caffeine, more velocity. Sleep is on the roadmap for a later quarter.",
      'GOLGARI': 'Hibernate. Bare minimum to survive until my energy returns.',
      'BOROS': 'Push through. Fatigue is just weakness leaving the body — a thing I now say more quietly, but still say.',
      ...
      'MARDU': 'Sprint to the finish. Rest comes after the victory. It is currently scheduled for after the victory after that.',
  ...
  ETHICS: {
    ...
    responses: {
      ...
      'IZZET': 'A genuinely fascinating ethical puzzle. I will map the full consequence tree — partly to find what is right, mostly because I love consequence trees.',
  ...
  MTG_STALL: {
    ...
    responses: {
      ...
      'MONO-R': "I attack. Into the full board. With everything. I will lose creatures. I don't care. Something has to happen, and I have decided to be that something.",
      ...
      'GRUUL': "I attack. All of them. If the board goes sideways, then at last the board is going somewhere.",
      ...
      'BOROS': "Cowardice, table-wide, duly noted. Fine. I'll break the stall myself. Consider this a charge.",
      ...
      'NAYA': "I rally the table. 'We're all friends here, which is exactly why we should all attack each other and see what happens.' I am, worryingly, sincere.",
...
const PROFILES = {
  ...
  'MONO-R':{
    ...
    pubBanter:"Could you please think for one minute before you set something on fire? The sweeping up is getting old. Although — and we say this grudgingly — the wall you demolished last month was one we'd been politely knocking on for a year.",
    cmd:'Krenko, Mob Boss',
  ...
  'SELESNYA':{
    ...
    pubBanter:"Can we fire anyone? Ever? Every conflict needs a healing circle, patience, and a 1:1 about feelings. Sometimes results matter more than us all liking each other. Although the team that likes each other is, annoyingly, the one still delivering three years later.",
  ...
  'DIMIR':{
    ...
    pubBanter:"Why do you know that? Why won't you tell us how you know that? Not every conversation is a negotiation. Although the one time it mattered, you knew three weeks early, and we notice we've stopped asking how.",
  ...
  'IZZET':{
    ...
    pubBanter:"Did you test this? At all? You experimented on production again and now everything's broken and you hand-waved it away as \"an interesting experiment\" and then started working on V2 while customers are yelling at us. V2, we are furious to report, is superb.",
  ...
  'GRUUL':{
    ...
    pubBanter:"Subtlety? Strategy? Never heard of them. You smash through everything and ignore feedback. Six months of subtle people had got precisely nowhere, which is why we called you. You came, you did the thing, and the thing is done. We are still finding out about the desk.",
  ...
  'GOLGARI':{
    ...
    pubBanter:"Everything is a metaphor about cycles of life or the natural order or rising from the ashes. Sometimes things need to work today, not in the fullness of the seasons. Although you did tell us the strategy was rotting a year before it fell over, and we're still deciding how to feel about that.",
  ...
  'SIMIC':{
    ...
    pubBanter:"You optimise everything to death. Can we ship at 80% and call it done? In six months you'll have shipped at 95%, but no-one will have a job any more because the product was meant to ship six months ago. The 95% version is, of course, the one the customers still talk about.",
  ...
  'BOROS':{
    ...
    pubBanter:"You treat quarterly planning like D-Day. Months on, the intensity is exhausting. Can you relax for one minute and stop talking about the greater good? Although when the actual crisis came, you were the one carrying people out of it, and we remember that longer than we remember the speeches.",
    ...
    weak:['Has a hammer. Struggles to not use it if something feels wrong or unfair.','Treats \'we could just send an email\' as a form of moral cowardice.','Can\'t quite tell the difference between a difficult conversation and a battle, and tends to err in favour of the second.','Hears that something unfair may have happened and is already out of their seat. The unfairness has not yet been verified. The seat is empty.','Has a list of people who are with us and a list of people who are not with us or are a wrong\'un.'],
  ...
  'BANT':{
    ...
    pubBanter:"Can we just pick something? You need three rounds of consultation, four spreadsheets, and a stakeholder map to decide where to go for lunch. It's already 3pm. The lunch will be excellent, everyone's dietary needs will be met, and we will all agree it was worth it, and we will all be lying slightly.",
  ...
  'ESPER':{
    ...
    weak:['Has solved for the optimum and can be mildly puzzled when people impacted by that optimisation seem upset.','There is an implicit tension between designing equitable frameworks and wanting those frameworks to favour them. Altruism only goes so far.','Can struggle to take action in unclear, information-poor situations such as a crisis.','Soft power is powerful, but every so often a bit of high-energy noise achieves things faster.','Refers to colleagues by their function and value rather than their name. Colleagues notice that.'],
  ...
  'NAYA':{
    ...
    pubBanter:"Why does every task need pep talks and a marching band? We just needed to update a spreadsheet. The spreadsheet got updated by Wednesday. We were also, somehow, at a parade. We don't fully understand how this works, and we have noticed that we keep showing up.",
    ...
    str:['Walks into a stalled room and the room remembers what it was doing.','Builds a team that, three weeks in, would run through walls for each other. The walls are still standing — everyone was, in the end, too busy being delighted with each other to hit them.','Knows everyone. Has had drinks with everyone. Has been forwarded the petition by everyone, and is partly why the petition succeeded.','Will start the thing nobody else thought was worth starting, and it will be worth starting by week two.','Means it. The earnestness is real. Other people\'s irony bounces off it.'],
    weak:['Treats the third hour of the Tuesday call with the same energy as the first ten minutes. The team does not.','The big speech was on Wednesday. The follow-up big speech is on Thursday. The follow-up to the follow-up speech is later on Thursday.','Believes the more interesting and fairer idea wins, which is almost always untrue. Surprised when it proves not to be.','Has so much enthusiasm for the work that quieter colleagues can\'t get a word in to say where it should actually point.','Is three suburbs away from the detail and the version control and the nuance.  That bites. Regularly.'],
  ...
  'ABZAN':{
    ...
    pubBanter:"You block every new idea with \"we've always done it this way.\" You keep a ledger of favours going back decades. We'd complain harder, but the roof is still on, and we've all seen what happened to the exciting companies.",
  ...
  'WITCH':{
    ...
    pubBanter:"We threw you a surprise party once, mostly as an experiment. You thanked us, filed the experience, and asked whether the budget had come from contingency. It had. You already knew.",
    ...
    weak:['Lacks the internal alarm that says a window is closing. Important windows close while the analysis matures.','Can come across as emotionally absent. Colleagues sometimes wonder if you actually care about the work.','Dismisses passionate ideas as "inefficient" without considering whether the passion was load-bearing.','Treats joy and energy as variables that don\'t usefully feature in any equation worth running.','Has, occasionally, watched a crisis happen and analysed it correctly while taking no action.'],
  ...
  'GLINT':{
    ...
    pubBanter:"Rules are for suckers, apparently. You hijack projects for fun and leave smoking wreckage everywhere. We never know what you're going to do next. Sometimes that's exciting. Mostly it's exhausting. Still — the deal that saved the quarter was yours, closed in a way none of us will describe under oath.",
  ...
  'DUNE':{
    ...
    pubBanter:"You charge in on instinct every time. Planning? Never. By the time we've picked up the pieces from the last impulse, you're three impulses ahead. Then it's Tuesday and the thing is done. We never figured out how. We've stopped asking.",
  ...
  'WUBRG':{
    ...
    cmdDesc:'Five colours at once — every angle available, no shortage of opinions about which to use',
